...
func (tc *ThemeCollection) ThemeFromHexTheme(th ThemeHex) *Theme {
	return NewTheme(
		th.Name,
		FromHex(th.BackMainColor),
		FromHex(th.BackSecondColor),
		FromHex(th.BackThirdColor),
		FromHex(th.FrontMainColor),
		FromHex(th.FrontSecondColor),
		FromHex(th.FrontThirdColor),
		FromHex(th.BrightMainColor),
		FromHex(th.BrightSecondColor),
		FromHex(th.BrightThirdColor),
