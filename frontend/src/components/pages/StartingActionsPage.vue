<template>
    ...
    <div class="right-bottom-buttons-container">
        <LinkButton link="/Github" iconColor="fill">
        ...
        <LinkButton link="/MadeInfo" iconColor="fill">
        ...
        <LinkButton link="/Settings" iconColor="stroke">
            <svg viewBox="-0.5 -0.5 24.5 24.5" fill="none">
