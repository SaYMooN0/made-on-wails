<template>
  <div id="action-choosing-container" class="action-choosing-part">
      ...
      <svg fill="#000000" version="1.1" class="left-panel-btn-icon left-panel-btn-icon-fill" viewBox="0 0 593.321 593.321"
        ...
        <g>
          ...
          <g>
            ...
            <path
              d="M314.039,186.772c-12.589,0-24.823-2.475-36.363-7.357c-11.125-4.705-21.108-11.433-29.671-19.996
    ...
    <LeftPanelButton buttonLabel="Text mode" @createTab="console.log('Text mode')">
      <svg class="left-panel-btn-icon left-panel-btn-icon-stroke" viewBox="0 0 24 24" fill="none">
        <path d="M4 17L10 11L4 5M12 19H20" stroke="#000000" stroke-width="1.7" stroke-linecap="round"
          stroke-linejoin="round" />
      </svg>
    </LeftPanelButton>
    <LeftPanelButton buttonLabel="Machineries" @createTab="console.log('Machineries')">
      <svg class="left-panel-btn-icon left-panel-btn-icon-stroke" viewBox="0 0 24 24" fill="none">
        <path
...
.action-choosing-part {
  ...
  padding-top: calc(6px + 0.4vh);
  width: calc(4vw + 100px + 7vh);
  height: calc(99.6vh - 6px);
  position: relative;
  left: 0;
}
